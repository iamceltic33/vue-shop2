    ...
    <div class="container header__container">
      <div class="header__logo-bar">
        <a href="#" class="logo-link"
          ><img
            ...
            alt="логотип"
            class="header__logo-bar_logo"
        /></a>
        <a href="#" class="search-link"
          ><img
            :src="require('../assets/img/search-icon.png')"
            alt="поиск"
            class="header__logo-bar_search"
        /></a>
      </div>
      <nav class="header__nav">
        <button type="button" class="menu-button header__nav-item">
          <svg
            width="32"
            height="23"
            viewBox="0 0 32 23"
        ...
        <a href="#" class="profile-link header__nav-item">
          <svg
            width="29"
            height="29"
            viewBox="0 0 29 29"
        ...
        <router-link to="/cart" class="cart-link header__nav-item">
          <svg
            width="32"
            height="29"
            viewBox="0 0 32 29"
      ...
      <nav class="nav-menu">
        <div class="nav-menu__wrapper">
          ...
          <p class="nav-menu__title">Menu</p>
          <ul class="nav-menu__categories">
            <li class="nav-menu__category-item">
              <a href="#" class="nav-menu__category-link">Man</a>
              <ul class="nav-menu__links">
                <li class="nav-menu__item">
                  <a href="#" class="nav-menu__link">Accessories</a>
                </li>
                <li class="nav-menu__item">
                  <a href="#" class="nav-menu__link">Bags</a>
                </li>
                <li class="nav-menu__item">
                  <a href="#" class="nav-menu__link">Denim</a>
                </li>
                <li class="nav-menu__item">
                  <a href="#" class="nav-menu__link">T-Shirts</a>
                </li>
              </ul>
            </li>
            <li class="nav-menu__category-item">
              <a href="#" class="nav-menu__category-link">Woman</a>
              <ul class="nav-menu__links">
                <li class="nav-menu__item">
                  <a href="#" class="nav-menu__link">Accessories</a>
                </li>
                <li class="nav-menu__item">
                  <a href="#" class="nav-menu__link">Jackets & Coats</a>
                </li>
                <li class="nav-menu__item">
                  <a href="#" class="nav-menu__link">Polos</a>
                </li>
                <li class="nav-menu__item">
                  <a href="#" class="nav-menu__link">T-Shirts</a>
                </li>
                <li class="nav-menu__item">
                  <a href="#" class="nav-menu__link">Shirts</a>
                </li>
              </ul>
            </li>
            <li class="nav-menu__category-item">
              <a href="#" class="nav-menu__category-link">Kids</a>
              <ul class="nav-menu__links">
                <li class="nav-menu__item">
                  <a href="#" class="nav-menu__link">Accessories</a>
                </li>
